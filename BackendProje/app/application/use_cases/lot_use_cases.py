...
class LotOlusturUseCase:
    def __init__(self, lot_repo: ILotRepository, log_repo: ISistemLogRepository):
        self._lot_repo = lot_repo
    ...
    def execute(self, dto: LotOlusturRequestDTO, kullanici_id: int) -> LotResponseDTO:
        ...
        kaydedilen = self._lot_repo.olustur(lot)
...
class LotGuncelleUseCase:
    ...
    def execute(
        ...
        kaydedilen = self._lot_repo.guncelle(mevcut)
