...
const PAGE_TITLES = {
    ...
    '/lotlar': { title: 'LOT Takibi', subtitle: 'Parti (LOT) bazlı stok yönetimi' },
    '/paletler': { title: 'Palet Yönetimi', subtitle: 'Depo içi palet işlemleri' },
    '/stok-hareketleri': { title: 'Stok İşlemleri', subtitle: 'Ürün giriş ve çıkış' },
    '/stok-sayim': { title: 'Stok Sayımı', subtitle: 'Envanter ve sayım kontrolü' },
    '/sevkiyatlar': { title: 'Sevkiyatlar (Çıkış)', subtitle: 'Sipariş çıkışları ve takip' },
    '/siparisler': { title: 'Siparişler', subtitle: 'Müşteri sipariş listesi' },
    '/sevkiyat-planlama': { title: 'Sevkiyat Planlama', subtitle: 'Rota ve araç atamaları' },
    '/irsaliyeler': { title: 'İrsaliyeler', subtitle: 'Giden ve gelen belgeler' },
    '/mal-kabul-irsaliyeleri': { title: 'Mal Kabul', subtitle: 'Tedarikçi giriş onayları' },
    '/inbound-dashboard': { title: 'Inbound Panel', subtitle: 'Mal kabul performans özeti' },
    '/kpi-dashboard': { title: 'KPI Paneli', subtitle: 'Performans ve verimlilik detayları' },
    '/zonlar': { title: 'Zon Yönetimi', subtitle: 'Depo bölge ve hücre işlemleri' },
    '/yerlestirme-gorevleri': { title: 'Görev Takibi', subtitle: 'Açık ve tamamlanmış görevler' },
    '/terminal/gorevler': { title: 'Terminal - Görev Listesi', subtitle: 'Aktif depo operasyonları' },
    '/terminal/yerlestirme': { title: 'Terminal - Yerleştirme', subtitle: 'El terminali mal yerleştirme' },
    '/terminal/ozet': { title: 'Terminal - Özet', subtitle: 'Saha performans durumu' },
    '/raporlar': { title: 'Raporlama Merkezi', subtitle: 'Sistem raporları ve veri aktarımı' },
    '/kullanicilar': { title: 'Kullanıcı Yönetimi', subtitle: 'Sistem kullanıcıları ve yetkilendirme' },
    '/tedarikciler': { title: 'Tedarikçi Yönetimi', subtitle: 'Anlaşmalı firma tanımları' },
    '/depolar': { title: 'Depo & Raf', subtitle: 'Depo mimarisi ve raf yapısı' },
    '/depo-kroki': { title: 'Depo Kroki', subtitle: 'Görselleştirilmiş raf durumu' },
    '/sistem-loglari': { title: 'Sistem Logları', subtitle: 'Uygulama hareket dökümü' },
    '/destek-masasi': { title: 'Destek Masası', subtitle: 'Talep ve yardım merkezi' },
