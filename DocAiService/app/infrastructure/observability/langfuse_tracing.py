"""Langfuse Cloud tracing helpers for DocAiService.
    ...
    *,
    ...
    try:
        ...
        try:
            ...
            logger.debug("Langfuse generation attributes skipped: %s", exc)
            stack.enter_context(nullcontext())
    except Exception as exc:  # noqa: BLE001
        logger.warning("Langfuse generation disabled: %s", exc)
        stack.close()
        yield _Observation()
        return
    ...
    try:
        ...
        try:
            ...
            logger.debug("Langfuse generation close skipped: %s", exc)
